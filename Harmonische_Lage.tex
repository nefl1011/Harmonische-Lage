...
\centering
\includegraphics[width=0.35\textwidth]{Bilder/fuer_mehrere_geraden.png}
\end{wrapfigure}
...
Da wir sowohl bei der harmonischen Lage als auch beim Goldenen Schnitt von von Teilverhältnissen sprechen, können wir diese zwei geometrischen Aspekte miteinander verbinden. %Allerdings betrachten wir beim Goldenen Schnitt 3 Punkte und 2 Strecken, während wir bei der harmonischen Lage 4 Punkte und 3 Strecken vorliegen haben. Wollen wir von der harmonischen Lage von vier Punkten $A, C, B$ und $D$ auf einer Geraden $g$ auf den Goldenen Schnitt prüfen, so können wir dies einfach tun: dazu brauchen wir nur die zwei Teilverhältnisse $TV(A B C)$ und $TV(A B D)$ betrachten. Aufgrund der Definition von harmonischer Lage und Doppelverhältnis müssen diese vom Betrag gleich sein und zugleich der Zahl des Goldenen Schnittes entsprechen.

%Wollen wir dagegen von einer Goldenen-Schnitt-Situation auf die harmonische Lage schließen, fehlt uns ein Punkt, den wir noch Konstruieren müssen. 
...
Mit dieser sehr geschickt gewählten Methode war es ab sofort möglich, jegliche Gegenstände perspektivisch Korrekt darzustellen. Im Laufe der Jahre wurde Albertis Perspektivkonstruktion von Personen wie Albrecht Dürer und Leonardo DaVinci auf mehrere Fluchtpunkte ausgeklügelt und mathematisch begründet. Doch kann dies als Grundstein für die nachkommenden perspektivischen Werke in der Kunstgeschichte betrachtet werden.

Tatsächlich sollte auch hier unser nun geschultes Auge erkennen, dass solche und andere perspektivischen Konstruktionen einer gewissen Harmonie entsprechen.
