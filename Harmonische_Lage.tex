...
Wollen wir unser erlerntes Wissen nun in der Praxis anwenden, zum Beispiel nämlich beim perspektivischen Zeichnen, so gibt es noch einen Sachverhalt, den wir noch nicht eingegangen sind:

Greifen wir unser gewähltes Beispiel einer perspektivischen Zeichnung auf: Gegenstände, Personen, etc.~ werden, je weiter sie vom Betrachter entfernt sind, immer kleiner dargestellt und streben dabei einem Punkt an, der in unendlich weiter Entfernung von uns weg liegt. Wenden wir die harmonische Lage auf einem projektiven Bild an, auf dem sich ein Quadrat befindet. 


% wo anders
Unser bis jetzt erlangtes Wissen über die harmonische Lage ist zwar gut und schön, doch wo können wir für dieses Thema Anwendung finden? Zur Beantwortung dieser Frage brauchen wir uns einfach nur unsere Umgebung genauer anzusehen. Die Wahrnehmung unseres Auges wird in unserem Kopf zu einem perspektivischen Bild dargestellt. Dabei ist für uns das Maß solcher perspektivischen Bilder selbstverständlich: regelmäßige und gleiche Abstände werden zum Horizont immer kleiner, parallele Strecken streben auf einen gemeinsamen Punkt zu, etc..  
